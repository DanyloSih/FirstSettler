...
namespace MarchingCubesProject
{
    ...
    public class BasicChunk : MonoBehaviour, IChunk
    {
        ...
        public Vector3Int VoxelsGridSize { get => _voxelsGridSize; }
            ...
            ChunkData chunkData)
        {
            ...
            _voxelsGridSize = _basicChunkSettings.ChunkSize - Vector3Int.one;
        ...
        public void UpdateMesh()
        {
            ...
            transform.position = Vector3.Scale(_chunkPosition, (_basicChunkSettings.ChunkSize - Vector3Int.one));
        }
